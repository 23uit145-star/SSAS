<?php
session_start();
$_SESSION['current_subject'] = 'python';
...
<form action="submit_test.php" method="post" id="pythonTestForm">
...
$q = mysqli_query($conn,"SELECT * FROM question WHERE language='Python'");
$i = 1;
...
document.getElementById("pythonTestForm").onsubmit = function(e){
